...
For a full VPS walkthrough (systemd, nginx `include`, updates) see [DEPLOY.md](../DEPLOY.md). This page is the application-level contract: unique data dirs, unique ports, keep the URL prefix.
